...
export class HideHeaderDirective implements AfterViewInit {
  ...
  // Une méthode de rappel qui est invoquée immédiatement après qu'Angular a terminé 
  // l'initialisation de la vue d'un composant. Elle n'est invoquée qu'une seule fois 
  // lorsque la vue est instanciée.
